"""Training script for custom Unitree GO2 and G1 RL environments.

Thin wrapper around Isaac Lab's RSL-RL training pipeline. Importing
...
Usage:
    ...
    python scripts/train.py --task Isaac-Velocity-Flat-Unitree-Go2-v0 --num_envs 4096

    # GO2 Velocity Tracking (Rough Terrain)
    python scripts/train.py --task Isaac-Velocity-Rough-Unitree-Go2-v0 --num_envs 4096
