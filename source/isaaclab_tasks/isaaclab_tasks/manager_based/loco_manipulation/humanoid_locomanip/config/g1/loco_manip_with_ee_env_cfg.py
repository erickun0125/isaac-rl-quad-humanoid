...
from .robots.unitree import G129_CFG_WITH_DEX3_BASE_FLOATING_FOR_LOCOMANIP_WITH_EE
...
class G1LocoManipSceneCfg(InteractiveSceneCfg):
    ...
    # Robots
    robot: ArticulationCfg = copy.deepcopy(G129_CFG_WITH_DEX3_BASE_FLOATING_FOR_LOCOMANIP_WITH_EE)
...
class G1LocoManipCurriculumCfg:
    ...
    # EE curriculum - gradually increase EE ranges
    ee_curriculum = CurrTerm(
        func=locomanip_mdp.reward_weight_curriculum,
        params={
            "reward_term_names": ["left_ee_pos_tracking", "right_ee_pos_tracking", "left_ee_pos_tracking_fine_grained", "right_ee_pos_tracking_fine_grained"],
            "tracking_reward_name": "track_lin_vel_xy_exp",
            "min_ratio": 0.5,
            "max_ratio": 1.0,
            "reward_threshold": 0.65,
    ...
    '''
@configclass
class G1LocoManipEEEnvCfg(ManagerBasedRLEnvCfg):
